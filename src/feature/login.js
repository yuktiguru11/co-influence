  ...
  const postLoginData = async (loginData) => {
    try {
      let data = await axios.post(
        "http://localhost:8000/postLoginData",
        loginData
      );
          ...
          <div class="max-w-md w-full mx-auto">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-2xl">
              ...
              <div className="flex justify-center mt-4">
                <button onClick={()=>{redirectToLogin}} className="w-1/3 p-3 mt-4 ml-4 bg-indigo-600 text-white rounded-l-lg shadow-xl">
                  Login{" "}
                </button>
                <button onClick={()=>{redirectToSignup}} className="w-1/3 p-3 mt-4 mr-4 bg-white text-indigo-600 rounded-r-lg shadow-xl">
                  Signup{" "}
                </button>
              </div>
              <div class="p-2">
